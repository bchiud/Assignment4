...
The downloaded original data files should be put within the working directory, in a subdirectory named `data`.

Once the R script is run, the output file will be created within the working directory.
